...
package com.fluxinated.mixins.floatingactionbuttons.shell.viewmover.movers;
...
import com.fluxinated.mixins.floatingactionbuttons.slf4j.Logger;
import com.fluxinated.mixins.floatingactionbuttons.slf4j.LoggerFactory;
...
public abstract class ViewMover {
	...
	/**
	 * {@link View}, which is to be moved
	 */
	 ...
	 *
	 * @param view {@link View}, which is to be moved
	 */
	ViewMover(View view) {
		this.view = view;
	}
	...
	private class MoveAnimationListener implements Animation.AnimationListener {
		 ...
		 * {@link com.fluxinated.mixins.floatingactionbuttons.shell.viewmover.movers.ViewMover.MoveAnimationListener}
		 *
