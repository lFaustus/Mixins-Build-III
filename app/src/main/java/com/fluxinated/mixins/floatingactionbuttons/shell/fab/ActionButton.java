...
package com.fluxinated.mixins.floatingactionbuttons.shell.fab;
...
import com.fluxinated.mixins.floatingactionbuttons.shell.uitools.convert.DensityConverter;
import com.fluxinated.mixins.floatingactionbuttons.shell.uitools.resutils.color.ColorModifier;
import com.fluxinated.mixins.floatingactionbuttons.shell.uitools.resutils.id.IdGenerator;
import com.fluxinated.mixins.floatingactionbuttons.shell.viewmover.configuration.MovingParams;
import com.fluxinated.mixins.floatingactionbuttons.shell.viewmover.movers.ViewMover;
import com.fluxinated.mixins.floatingactionbuttons.shell.viewmover.movers.ViewMoverFactory;
...
public class ActionButton extends View {
	 ...
	 * while in the {@link com.fluxinated.mixns..shell.fab.ActionButton.State#PRESSED} state
	 */
	 ...
	 * <p>
	 * Shadow Responsive Effect means that shadow is enlarged up to the certain limits
	 * while in the {@link com.fluxinated.mixins.floatingactionbuttons.shell.fab.ActionButton.State#PRESSED} state
	 *
	 ...
	 *    on {@link MotionEvent#ACTION_MOVE} in case when touch point
